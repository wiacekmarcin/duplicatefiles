...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Tue Jul 30 14:19:46 2013
# Project:  DuplicateFiles.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile DuplicateFiles.pro
#############################################################################
...
Makefile: DuplicateFiles.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/DuplicateFiles1.0.0/ && $(COPY_FILE) --parents dpfile.h dpdir.h err.h utils.h taskprogress.h taskprogressmanager.h mainwindow.h test.h .tmp/DuplicateFiles1.0.0/ && $(COPY_FILE) --parents main.cpp dpfile.cpp dpdir.cpp utils.cpp taskprogress.cpp taskprogressmanager.cpp mainwindow.cpp test.cpp .tmp/DuplicateFiles1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/DuplicateFiles1.0.0/ && (cd `dirname .tmp/DuplicateFiles1.0.0` && $(TAR) DuplicateFiles1.0.0.tar DuplicateFiles1.0.0 && $(COMPRESS) DuplicateFiles1.0.0.tar) && $(MOVE) `dirname .tmp/DuplicateFiles1.0.0`/DuplicateFiles1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/DuplicateFiles1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_test.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_test.cpp
